        ...
        <table class="table table-striped table-hover">
            ...
            <tr v-for="(item,index) in lista">
                ...
                <td v-if="detalhe || editar || deletar">|
                    ...
                    <modal-link v-if="criar && modal" tipo="link" nome="detalhe" titulo="Detalhe |"></modal-link>

                    <a v-if="editar && !modal" v-bind:href="editar">Editar |</a>
                    <modal-link v-if="criar && modal" tipo="link" nome="editar" titulo="Editar |"></modal-link>
